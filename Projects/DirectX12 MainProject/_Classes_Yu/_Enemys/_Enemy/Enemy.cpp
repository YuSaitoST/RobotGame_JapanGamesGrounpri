...
void Enemy::Initialize(const int id) {
	...
	se_adjacent_->Initialize(seNameAtk, SOUND_TYPE::SE, 0.5f);  // âºÇÃílÅAòAë±çUåÇÇ»ÇÁâπïœÇÌÇÈÇ©Ç‡ÇæÇ©ÇÁÇ±Ç±ÇÃédólÇ™ïœÇÌÇËÇªÇ§
	se_shooting_->Initialize(seNameBem, SOUND_TYPE::SE, ENParams.FREQUENCY_OF_SHOOTING);  // Ç±Ç±ÇÃä‘äuÇÕéÀåÇÇÃïpìxÇ…çáÇÌÇπÇƒ
