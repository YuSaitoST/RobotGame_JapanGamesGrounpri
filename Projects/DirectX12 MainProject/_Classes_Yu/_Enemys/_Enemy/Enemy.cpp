...
void Enemy::Initialize(const int id) {
	...
	se_adjacent_->Initialize(L"_Sounds\\_SE\\_Attack\\SELab_useOnesSword1.wav", SOUND_TYPE::SE, 0.5f);  // ‰¼‚Ì’lA˜A‘±UŒ‚‚È‚ç‰¹•Ï‚í‚é‚©‚à‚¾‚©‚ç‚±‚±‚ÌŽd—l‚ª•Ï‚í‚è‚»‚¤
	se_shooting_->Initialize(L"_Sounds\\_SE\\_Attack\\SELab_beamCannon1.wav", SOUND_TYPE::SE, ENParams.FREQUENCY_OF_SHOOTING);  // ‚±‚±‚ÌŠÔŠu‚ÍŽËŒ‚‚Ì•p“x‚É‡‚í‚¹‚Ä
